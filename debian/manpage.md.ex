% sql-tool(SECTION) | User Commands
%
% "September  3 2025"
...
sql-tool - program to do something

# SYNOPSIS

**sql-tool** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sql-tool** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sql-tool** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sql-tool** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sql-tool. See **foo.conf**(5) for further details.
...
**sql-tool** provides some return codes, that can be used in scripts:
